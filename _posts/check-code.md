...
```
    ...
    <li>
      ...
      <img src="../assets/img/devices-button.png" alt="Кнопка включения эмулятора мобильных устройств">
      ...
      <img src="../assets/img/add-device.png" alt="Добавить устройство">
      ...
      <img src="../assets/img/devices-list.png" alt="Список устройств">
    ...
    <li>
      ...
      <img src="../assets/img/switch-dpr.png" alt="Меню выбора плотности пикселей">

      <p>Если там нет такой опции, нажмите на три точки в правой части панели устройств и включите её в выпадающем меню:</p>

      <img src="../assets/img/add-dpr.png" alt="Включить меню выбора плотности пикселей">
      ...
      <img src="../assets/img/check-img.png" alt="Панель сетевых загрузок, картинки">
