...
links:
 - name: 'Простой список'
   url: '#simple-list'
 - name: 'Картинка пользователя (юзерпик)'
   url: '#userpic'
 - name: 'Галерея'
   url: '#gallery'
 - name: 'Навигация (простой вариант)'
   url: '#nav-1'
 - name: 'Навигация (сложный вариант)'
   url: '#nav-2'
 - name: 'Виджет в боковой колонке'
   url: '#widget'
 - name: 'Блок новостей'
   url: '#news'
 - name: 'Статья или пост в блоге (простой вариант)'
   url: '#simple-article'
 - name: 'Статья или пост в блоге (сложный вариант)'
   url: '#article'
 - name: 'Разметка страницы'
   url: '#page-markup'
---
