...
<ol>
  <li>
    <h2 id="sense">Используйте HTML-тэги по смыслу
  ...
  <li>
    <h2 id="bem">Используйте БЭМ для именования классов
  ...
  <li>
    <h2 id="common-words">Используйте в названиях классов простые и короткие слова
