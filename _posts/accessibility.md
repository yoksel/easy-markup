...
<h2 id="accessibility-simple">Доступность — это просто</h2>
...
<h2 id="examples">Покажите мне всё</h2>

<p>Самые простые примеры:</p>

<dl>
  <dt><h3 id="links-buttons">Ссылки и кнопки</h3></dt>
  <dd>
  ...
  <dt><h3 id="headers">Заголовки</h3></dt>
  <dd>
...
```
  ...
  <dt><h3 id="images">Изображения</h3></dt>
  ...
  <dt><h3 id="forms">Элементы формы</h3></dt>
