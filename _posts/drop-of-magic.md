...
<ol>
    <li>
        <h2 id="target" title="Цитата из к/ф «Чародеи»">Цель вижу, в себя верю! <a class="post__anchor" href="#target">#</a></h2>
...
```
    ...
    <li>
        <h2 id="dusk" title="Цитата из к/ф «Ночной дозор»">Всем выйти из сумрака! <a class="post__anchor" href="#dusk">#</a></h2>
